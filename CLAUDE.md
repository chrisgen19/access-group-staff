...
**Name:** Access Recognition
**Description:** Internal employee recognition app for Access Group. 
Team members publicly recognize colleagues via digital thank-you cards 
tied to company values. Phase 1 covers project setup, auth, and user management.
**Optional packages needed:** zustand, react-query, resend, next-themes
